...
# Publication type.
# For a poster/presentation, use speech.
...
# If you want a thumbnail on the listing page, add a PNG/JPG here.
image:
  caption: 'EGU 2026 poster'
  focal_point: 'Center'
  preview_only: true
...
{{% callout note %}}
Download the poster as a PDF using the **PDF** or **Poster** link above.
{{% /callout %}}
